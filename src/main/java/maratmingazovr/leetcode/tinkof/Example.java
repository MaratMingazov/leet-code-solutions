...
public class Example {
    ...
    public static void main(String[] args) {
        ...
        getCandles(api, instrumentFigi, CandleInterval.CANDLE_INTERVAL_HOUR);
...
//        positionsStreamExample(api);
    ...
    private static List<String> randomFigi(InvestApi api, int count) {
        ...
        List<Share> list = api.getInstrumentsService().getTradableSharesSync();
        System.err.println("STAERT = "  + list.size());
    ...
    private static void getCandles(InvestApi api, String figi, CandleInterval interval) {
        List<HistoricCandle> candles = api.getMarketDataService().getCandlesSync(figi, Instant.now().minus(1, ChronoUnit.DAYS), Instant.now(), CandleInterval.CANDLE_INTERVAL_1_MIN);
